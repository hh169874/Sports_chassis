...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, Buzzer_Pin|LED1_Pin|LED2_Pin|LED3_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : Gyro_Reset_Pin */
  GPIO_InitStruct.Pin = Gyro_Reset_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(Gyro_Reset_GPIO_Port, &GPIO_InitStruct);
